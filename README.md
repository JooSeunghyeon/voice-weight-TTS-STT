...
3. [`notebooks/kaggle_voice_translator.ipynb`](notebooks/kaggle_voice_translator.ipynb)의 셀을 순서대로 실행합니다.
4. Cloudflare 셀에서 출력되는 `https://*.trycloudflare.com` 주소를 Gradio public URL로 사용합니다.
5. Share 설정에서 notebook 권한을 Public으로 변경합니다.
